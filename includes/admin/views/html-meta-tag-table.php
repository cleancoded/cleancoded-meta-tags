        ...
        <table class="widefat striped">
            <thead>
                <tr>
                    ...
                    // meta tag groups
                    foreach ($CLEANCODED_meta_tag_list as $item => $details){
                        echo '<th>'. $item .' 
            ...
            <?php
                ...
                $items = CLEANCODED_Retrieve_List::get_list( $type, $items_per_page, $offset );
                
                $taginfo = new CLEANCODED_Retrieve_Tags( $CLEANCODED_meta_tag_list );
                    ...
                    foreach ( $items['list'] as $item ){
                        ...
                        <tr>
                            ...
                            foreach ($statuses as $group => $status){
                                ...
                                $var = $CLEANCODED_meta_tag_list[$group]['var'];
            ...
            <tfoot>
                ...
                // always autopilot buttons
                    ...
                    foreach ($CLEANCODED_meta_tag_list as $group => $info){
                        ...
                        if ( $group != 'Custom' ){
                            ...
                            if ( 
                                !empty($CLEANCODED_autopilot_settings) &&
