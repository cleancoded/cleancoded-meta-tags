...
// get object title
$iteminfo = new CLEANCODED_Retrieve_Info($_GET['type'], $_GET['edit']);
...
<div class="wrap dpmt-editor">
    ...
    echo '<input name="action" type="hidden" value="CLEANCODED_editor_form_submit" />';


    // submit item type and id via post method as well
    echo '
    <input name="CLEANCODED_type" type="hidden" value="'. $_GET['type'] .'" />
    <input name="CLEANCODED_id" type="hidden" value="'. $_GET['edit'] .'" />
    ';
    ...
    // list all tags
    foreach ( $CLEANCODED_meta_tag_list as $group => $items ){
            ...
            <tr>
                ...
                <td>';
                    ...
                    if ( !empty($tag['values']) ){
                        ...
                        if( $tag['variable'] == 'CLEANCODED_custom' ){
