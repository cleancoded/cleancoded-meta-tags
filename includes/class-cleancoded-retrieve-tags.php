...
class CLEANCODED_Retrieve_Tags {
        ...
        foreach ( $this->list_of_meta_tags as $group => $item ){
            ...
            foreach ( $item['fields'] as $tag => $field ){
                ...
                switch (true){
                    ...
                    case $type == 'frontpage':                        
                        $retrieved_tag_list[$group][$field['variable']] = get_option( 'CLEANCODED_frontpage_' . $field['variable']);
    ...
    public function set_status(){
        ...
        foreach ( $this->retrieved_tag_list as $group => $tags ){
            ...
            if ( $group == 'Custom' && ! empty($tags['CLEANCODED_custom']) ){
