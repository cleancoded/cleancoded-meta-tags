    ...
    __( 'General tags', 'dp-meta-tags' ) => [
        ...
        'fields' => [
            'description' => [
                ...
                'variable' => 'CLEANCODED_general_description'
            ],
            ...
            'keywords' => [
                ...
                'variable' => 'CLEANCODED_general_keywords'
            ]
        ]
    ],
    ...
    __( 'Open Graph', 'dp-meta-tags' ) => [
        ...
        'fields' => [
            'og:title' => [
                ...
                'variable' => 'CLEANCODED_og_title'
            ],
            'og:description' => [
                'info' => __( 'A short summary about the content.', 'dp-meta-tags' ),                
                'variable' => 'CLEANCODED_og_description'
            ],
            'og:type' => [
                ...
                'variable' => 'CLEANCODED_og_type'
            ],
            'og:audio' => [
                'info' => __( 'URL to your content\'s audio.', 'dp-meta-tags' ),                 
                'variable' => 'CLEANCODED_og_audio'
            ],
            'og:image' => [
    ...
    __( 'Twitter Cards', 'dp-meta-tags' ) => [
        ...
        'fields' => [
            ...
            'twitter:image' => [
                ...
                'variable' => 'CLEANCODED_twitter_image'
            ],
            'twitter:image:alt' => [
                'info' => __( 'A text description of the image for visually impaired users.', 'dp-meta-tags' ),
                'variable' => 'CLEANCODED_twitter_image_alt'
            ],
            'twitter:player' => [
